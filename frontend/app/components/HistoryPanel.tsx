        ...
        >
          <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-sm w-full mx-4">
            ...
            <p className="text-sm text-gray-500 mb-6">
              Esta acción borrará todos los elementos e imágenes. No se puede deshacer.
            </p>
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        >
          <h2 className="text-2xl font-bold text-gray-900">
            ...
            <span className="ml-2 text-sm font-normal text-gray-400">({history.length}{hasMore ? "+" : ""})</span>
          </h2>
          <svg
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium text-red-600 border border-red-200 rounded-lg hover:bg-red-50 transition-colors focus:outline-none focus:ring-2 focus:ring-red-400"
        >
            ...
            {history.map((item, index) => (
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <p className="text-sm text-gray-600 line-clamp-2 italic">&ldquo;{item.message}&rdquo;</p>
                </div>
              </div>
            ))}
          </div>
          ...
          {hasMore && (
            <div className="mt-8 flex justify-center">
              <button
                ...
                className="flex items-center gap-2 px-6 py-2.5 text-sm font-medium text-blue-600 border border-blue-200 rounded-xl hover:bg-blue-50 disabled:opacity-50 disabled:cursor-not-allowed transition-colors focus:outline-none focus:ring-2 focus:ring-blue-400"
              >
                {loadingMore ? (
                  <>
